...
import com.lex.news.ui.BaseActivity;
...
public class HomeActivity extends BaseActivity
    ...
    protected void onCreateImpl() {
        ...
        BasePresenter presenter = new HomePresenter(fragment);
        getFragmentManager().beginTransaction().add(R.id.content_home, fragment).commit();
